...
\ifsetDraft
  ...
  \newwatermark*[pages=2-,color=red!50,angle=0,scale=.3,xpos=0cm,ypos=3.5cm,fontseries=b]{\fcolorbox{red!50}{blue!0}{{\drafttext}\space-\space{\draftVersion}\space{\timestamp}}}
\fi 
