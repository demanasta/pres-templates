...
\ifsetDraft
  ...
  % Bottom
  \newwatermark*[pages=2-,color=red!60,textalign=center,angle=0,scale=.35,xpos=-.2cm,ypos=-.437\paperheight]{\makebox[.9\textwidth]{{\drafttext}\space-\space{\draftVersion}\space{\timestamp}}}
  %Flush right
